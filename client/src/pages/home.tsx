              ...
              <div className="flex flex-col justify-center space-y-8">
                ...
                <div className="flex flex-col gap-4 min-[400px]:flex-row">
                  <a href="tel:911429862" className="w-full sm:w-auto">
                    <Button size="lg" className="w-full sm:w-auto rounded-none text-lg h-14 px-8 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors">
        ...
        <section className="py-12 md:py-24 bg-muted/30 border-b border-border">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {/* Service 1 */}
              <div className="group relative overflow-hidden bg-background p-8 border border-border hover:border-primary transition-colors duration-300">
                ...
                <div className="w-8 h-[2px] bg-border group-hover:bg-primary transition-colors"></div>
              </div>
            ...
            <div className="grid gap-12 lg:grid-cols-2">
              <div className="space-y-8">
                ...
                <div className="space-y-6 text-lg">
                  ...
                  <div className="flex items-start gap-4">
                    <Clock className="h-6 w-6 mt-1 shrink-0 text-primary" />
                    <div>
                      <p className="font-bold">Opening Hours</p>
                      <p className="text-muted-foreground">Mon - Fri: 10:00 - 15:00 / 16:00 - 21:00</p>
                      <p className="text-muted-foreground">Sat: 10:30 - 14:30 / 17:00 - 21:00</p>
